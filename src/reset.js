    ...
    handleNewPasswordSubmit(e) {
        ...
        axios
            ...
            .catch((error) => {
                ...
                this.setState({
                    errorNewPWSubmit:
                        "Invalid code, please double check your code!",
                });
            });
    }
        ...
        return (
            <div>
                {currentDisplay == 1 && (
                    <div>
                        <h2>
                            Please enter your email if you would like to reset
                            your password
                        </h2>
                ...
                {currentDisplay == 2 && (
                    <div>
                        <h2>
                            You will receive an email with a secret code. Please
                            enter that code here and choose a new password.
                        </h2>
